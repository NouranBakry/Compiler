...
public class Maximal_munch {
    ...
    public static int state = 0, i = 0, forward, token_beginning = 0;
    public static int lexical_value;
    public static String test = new String();
    public static String start = "1", dead = "0";
    public static ArrayList<String> states = new ArrayList<>(), accept = new ArrayList<>(),
            keywords = new ArrayList<>(), relop = new ArrayList<>(), punctuations = new ArrayList<>(),
            addop = new ArrayList<>(), mulop = new ArrayList<>();
